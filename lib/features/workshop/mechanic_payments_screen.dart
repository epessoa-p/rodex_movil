...
/// Tab Mecánicos (Pagos): lista de mecánicos con su pendiente; abre el detalle
/// por OT. Solo cuerpo: la pantalla Pagos pone AppBar y barra de tabs.
class MechanicPaymentsTab extends ConsumerWidget {
  const MechanicPaymentsTab({super.key});
